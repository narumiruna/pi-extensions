...
Choose **Open a note…**, **Create a note…**, **Paste a note path…**, or **Manage templates…**. Existing note names appear only after opening the dedicated note list. New notes can be blank or copy a Markdown template found at `${getAgentDir()}/pi-notes/templates/`; the extension does not seed templates.
