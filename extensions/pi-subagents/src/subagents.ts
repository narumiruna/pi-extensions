...
export default function (pi: ExtensionAPI) {
	pi.registerTool<typeof SubagentParams, SubagentDetails>({
		...
		promptGuidelines: [
			...
			"After detached spawn, do useful non-overlapping work immediately. Call subagent_wait sparingly, only when the immediate next critical-path step requires the result and is blocked until it arrives; do not wait repeatedly by reflex.",
			"Consume and synthesize available detached completion messages; interrupt or close agents that are no longer needed.",
