...
```bash
PI_TY_LSP_COMMAND="uvx ty server" PI_RUFF_LSP_COMMAND="uvx ruff server" pi -e ./deprecated/pi-python-lsp
```

Optional timeout overrides:

```bash
PI_TY_LSP_TIMEOUT_MS=30000 PI_RUFF_LSP_TIMEOUT_MS=30000 pi -e ./deprecated/pi-python-lsp
```
